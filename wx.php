...
class wechatCallbackapiTest
{
    ...
    private function receiveText($object)
    {
        ...
        if (strstr($keyword, "文本")){
            ...
            $content = array();
            $content[] = array("Title"=>"标题",  "Description"=>"内容", "PicUrl"=>"http://imgsrc.baidu.com/forum/w=580/sign=84ddbd17fdedab6474724dc8c734af81/6ad105166d224f4a0076b0cf0ff790529922d12e.jpg", "Url" =>"http://www.matchutest.applinzi.com/0.html");
        }
